...
def boundary_to_tikz_code(data):
    ...
    """
    string = "\\begin{scope}[mirror/.style={black, very thin, line cap=round}, open/.style={opacity=0}, input/.style={red!80, line cap=round}, output/.style={blue!80, line cap=round}]%\n"
